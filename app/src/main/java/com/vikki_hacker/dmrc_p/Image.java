...
public class Image extends AppCompatActivity implements View.OnClickListener  {
    ...
    private String UPLOAD_URL ="http://comfiest-tide.000webhostapp.com/upload.php";
    ...
    private void uploadImage(){
       ...
       // UPLOAD_URL = UPLOAD_URL+"/?image="+getStringImage(bitmap)+"&name="+editTextName.getText().toString().trim();
